...
export interface Observation {
  ...
  /** Original voice transcript used to extract this observation (null if manual entry) */
  voiceTranscript?: string | null
  /** Per-field confidence scores 0-1 from AI extraction (null if manual entry) */
...
export interface CircuitDetail {
  ...
  /** Original voice transcript used to extract this circuit (null if manual entry) */
  voiceTranscript?: string | null
  /** Per-field confidence scores 0-1 from AI extraction (null if manual entry) */
  fieldConfidence?: Record<string, number> | null
}
